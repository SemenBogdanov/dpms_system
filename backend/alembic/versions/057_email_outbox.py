...
Письмо формируется после одного часа без новых сообщений в этой переписке.
Если за это время приходит еще одно сообщение, часовое окно начинается заново,
а накопленные сообщения объединяются в одно письмо. Это не превращает почту в
дубликат мессенджера и не создает лишний шум.

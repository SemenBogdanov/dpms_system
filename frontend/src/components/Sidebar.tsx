...
const nav: Array<
  {
    ...
    section: 'task' | 'feedback' | 'development' | 'personal' | 'settings' | 'admin'
...
> = [
  ...
  { to: '/quick-notes', label: 'Заметки', icon: StickyNote, section: 'personal' },
  { to: '/personal-tasks', label: 'Личные задачи', icon: ListChecks, section: 'personal' },
  { to: '/deadline-trackers', label: 'Трекер сроков', icon: CalendarClock, section: 'personal' },
